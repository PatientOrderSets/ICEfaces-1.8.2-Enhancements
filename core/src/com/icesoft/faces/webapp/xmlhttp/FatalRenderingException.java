...
/**
 * <p>The {@link FatalRenderingException} exception is thrown whenever rendering
 ...
 * resources associated with the particular client.</p>
 */
public class FatalRenderingException extends RenderingException {
     ...
     */
    public FatalRenderingException(String message) {
        super(message);
    }
     ...
     */
    public FatalRenderingException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The root cause for this exception
     */
    public FatalRenderingException(Throwable cause) {
        super(cause);
    }
