...
/**
 * The <code>ContextInitializedEvent</code> class represents an event that
 * should be fired when the context is initialized in order to give registered
 * listeners time to do proper set up and/or other appropriate actions. </p>
 */
public class ContextInitializedEvent
    ...
    /**
     * Constucts a <code>ServletInitializedEvent</code> with the specified
     ...
     *                              </code>null</code>.
     */
    public ContextInitializedEvent(ServletContextEvent servletContextEvent)
     ...
     * <code>ContextInitializedEvent</code>. </p>
     *
    ...
    /**
     * Gets the servlet context of this <code>ContextInitializedEvent</code>.
     * </p>
     *
