...
public class TldLocationsCache {
     ...
     *                     tag library from the same jar, at the expense of
     *                     slowing down the server a bit. Note that this may
     *                     only work on JDK 1.3.1_01a and later, because of JDK
     *                     bug 4211817 fixed in this release. If redeployMode is
     *                     false, a faster but less capable mode will be used.
     */
                    ...
                    for (int i = 0; i < urls.length; i++) {
                        ...
                        if (conn instanceof JarURLConnection) {
                            ...
                            if (urlStr.startsWith(FILE_PROTOCOL)
                                ...
                                scanJar((JarURLConnection) jarURL
                                        .openConnection(),
                                        true);
                            }
                        }
