...
public class CityDictionary implements Serializable {
    ...
    private static final String DATA_RESOURCE_PATH =
            "/WEB-INF/classes/org/icefaces/sample/location/resources/city.xml.zip";
    ...
    public CityDictionary() {
        ...
        try {
            log.info(MessageBundleLoader.getMessage("find.initializingDictionary"));
            ...
            if (log.isErrorEnabled()) {
                log.error(MessageBundleLoader.getMessage("find.initializingDictionary"));
            }
        }
    }
