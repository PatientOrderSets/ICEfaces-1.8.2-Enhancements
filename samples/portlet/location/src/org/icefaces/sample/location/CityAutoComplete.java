...
/**
 * <p>The CityAutoComplete class is responsible handling the auto
 * complete lookup and selection</p>
 *
 * @since 1.7
 */
public class CityAutoComplete extends BaseBean {
    ...
    private static int cityListLength = 10;
    ...
    //coordinates the updating the display across multiple portlets
    ...
    public void selectInputValueChanged(ValueChangeEvent event) {
        ...
        if (event.getComponent() instanceof SelectInputText) {
            ...
            coordinator.setCurrentCity(selectedCity);
    ...
    public void setSelectedCityValue(String selectedCityValue1) {
        this.selectedCityValue = selectedCityValue1;
    }
