...
public class TimeZoneBean implements Renderable, DisposableBean {
    ...
    /**
     * List of all possible {@link TimeZoneWrapper} objects, which determine the
     * map and checkbox UIs.
     */
    ...
    /**
     * Gets ArrayList of all possible <code>TimeZoneWrapper</code> objects.
     *
