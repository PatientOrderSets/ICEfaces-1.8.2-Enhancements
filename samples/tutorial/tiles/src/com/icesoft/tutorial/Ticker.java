...
/**
 * Clock Bean for the Time Zone Tiles application. This bean starts a thread
 * that will update state at a specified polling interval.
 */
public class Ticker implements Runnable {
    ...
    /**
     * Method for referring to ticker from a given page so that * it is
