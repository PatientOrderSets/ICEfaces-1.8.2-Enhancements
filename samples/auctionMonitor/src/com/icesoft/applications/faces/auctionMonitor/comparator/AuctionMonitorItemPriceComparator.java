...
/**
 * Class used to compare the prices of two auction items
 */
public class AuctionMonitorItemPriceComparator
        extends AuctionMonitorItemComparator {
    public int compare(AuctionMonitorItemBean bean1,
                       AuctionMonitorItemBean bean2) {
        return ((int) (bean1.getCurrentPrice() - bean2.getCurrentPrice()));
    }
}
