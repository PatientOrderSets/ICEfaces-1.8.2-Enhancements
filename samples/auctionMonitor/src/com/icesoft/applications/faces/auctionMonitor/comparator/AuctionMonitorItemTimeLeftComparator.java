...
/**
 * Class used to compare the auction time remaining for two auction items
 */
public class AuctionMonitorItemTimeLeftComparator
        extends AuctionMonitorItemComparator {
    public int compare(AuctionMonitorItemBean bean1,
                       AuctionMonitorItemBean bean2) {
        return ((int) (bean1.getTimeLeft() - bean2.getTimeLeft()));
    }
}
