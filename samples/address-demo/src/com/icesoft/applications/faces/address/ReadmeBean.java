...
/**
 * Toggles the ReadMe information at the bottom of the application. Accesses
 * information stored in readme.html.
 */
public class ReadmeBean {

    private boolean expanded = false;

    private String readmeText = "Readme";
    ...
    // the default constructor will build the readme in html format
    public ReadmeBean() {
        try {
            Reader readmeReader = new InputStreamReader(
                    this.getClass()
                            .getClassLoader()
                            .getResourceAsStream(
                            "com/icesoft/applications/faces/address/readme.html"));
